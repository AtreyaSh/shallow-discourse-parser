...
def recalc():
    ...
    for direct in files:
        ...
        for nn in NN:
            ...
            reportTrain = classification_report(output_train, exp.predict(input_train), digits = 7)
            reportDev = classification_report(output_dev, exp.predict(input_dev), digits = 7)
            reportTest = classification_report(output_test, exp.predict(input_test), digits = 7)
