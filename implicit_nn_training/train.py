...
def single(trainpath, devpath, testpath, args):
    ...
    accs, report, recs, precs, f1s = train_keras(method, learning_rate, momentum, decay, regularization, hidden, min_improvement, validate_every, patience, weight_lx, hidden_lx, embeddings, current_run_name, "single", 3, dropout, epochs)
